 ...
 * @author USER
 */
public class FormTambahPengembalian extends javax.swing.JFrame {

    /**
     * Creates new form FormTambahPengembalian
     */
    ...
    private void initComponents() {
        ...
        jLabel2.setText("TAMBAH DATA PENGEMBALIAN PC");

        jPanel2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        jLabel11.setText("Kode Kembali");

        jLabel12.setText("Kode Sewa");

        jLabel13.setText("Kode PC");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormTambahPengembalian().setVisible(true);
            }
        });
    }
