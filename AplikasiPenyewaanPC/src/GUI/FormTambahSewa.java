 ...
 * @author USER
 */
public class FormTambahSewa extends javax.swing.JFrame {

    /**
     * Creates new form FormTambahSewa
     */
    public FormTambahSewa() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("PENYEWAAN PC");

        jPanel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        jLabel3.setText("Kode Sewa");

        jLabel4.setText("Kode PC");
        ...
        jLabel2.setText("TAMBAH DATA PENYEWAAN PC");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormTambahSewa().setVisible(true);
            }
        });
    }
